...
template <class T>
pl_list<T>::pl_list(size_t capacity)
{
    initialize(capacity);
}
...
template <class T>
pl_list<T>::pl_list(pl_cell<T> *cells, size_t ncells, external_storage_policy)
{
...
template <class T>
size_t pl_list<T>::size() const
{
    return size_;
}

template <class T>
size_t pl_list<T>::capacity() const
{
    return capacity_;
}
...
template <class T>
void pl_list<T>::initialize(size_t capacity, pl_cell<T> *extcells)
{
