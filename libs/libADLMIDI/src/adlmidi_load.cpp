...
bool MIDIplay::LoadMIDI_post()
{
    ...
    if(format == MidiSequencer::Format_CMF)
    {
        ...
        for(uint16_t i = 0; i < ins_count; ++i)
        {
            ...
            /*printf("Ins %3u: %02X %02X %02X %02X  %02X %02X %02X %02X  %02X %02X %02X %02X  %02X %02X %02X %02X\n",
        ...
        //printf("CMF deltas %u ticks %u, basictempo = %u\n", deltas, ticks, basictempo);
    ...
    {
        //fprintf(stderr, "Done reading IMF file\n");
